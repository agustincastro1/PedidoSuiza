...
<head>
    ...
    <title>Login - PedidoSuiza</title>
    <link rel="stylesheet" href="../CSS/estiloLoginPedidoSuiza.css">
</head>

<body>
    <!-- 1. El mosaico desordenado basado en tu imagen (Bento Grid) -->
    ...
    <!-- 3. Contenedor principal que centra la tarjeta -->
